...
namespace BreadEditor {
    ...
    int UiElement::getIndex() const
    {
        ...
        return static_cast<int>(std::ranges::find(parentChilds, this) - parentChilds.begin());
    }
    ...
    {
        return Engine::isCollisionPointRec(pos, bounds);
    }
